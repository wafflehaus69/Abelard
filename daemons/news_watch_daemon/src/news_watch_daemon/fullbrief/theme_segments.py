...
_SYSTEM_INSTRUCTIONS = (
    ...
    "SPECIFICS: name the deals, companies, programs, and figures. Favor "
    "COMPLETENESS of the distinct developments over compression — do NOT "
    "generalize away the numbers or collapse separate threads into vague "
    "summary. Six sentences is fine when the window is dense with material.\n"
