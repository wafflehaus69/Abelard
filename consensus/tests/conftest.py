...
BASE_CONFIG: dict = {
    ...
    "m0f": {
        "news_break_ts": 1772260414,
        "window_start_ts": 1771545600,
        "window_end_ts": 1772323200,
        "baseline_days": 7,
        "search_terms": ["us strikes iran"],
        "size_floor_usdc": 5000,
        "directional_min": 0.8,
        "factor_weights": {"F": 1.0, "S": 1.0, "A": 0.7, "D": 0.8, "C": 0.8, "T": 0.5, "P": 1.0},
        "cluster_min": 3,
        ...
        "labeled_hypotheses": [
            {"name": "known", "address": "0xKNOWN", "approx_shares": 560680, "approx_price": 0.108},
            {"name": "sig-only", "approx_shares": 200747, "approx_price": 0.132},
        ],
    },
    "m0c": {
        "replay_start_ts": 1735689600,
        "replay_end_ts": 1777593600,
        "categories": ["geopolitics"],
        "min_resolved_trades": 10,
        "decay_half_life_days": 90,
        "mm_two_sided_frac": 0.35,
        "circle_size_k": 15,
        "participation_floor": 4,
        ...
        "sweep": {
            ...
            "circle_size_k": [10, 15],
            "max_edge_paid": [0.05, 0.10],
        },
        "regime_slices": [
            {"name": "2025-H1", "start": 1735689600, "end": 1751328000},
        ],
    },
    "collector": {
